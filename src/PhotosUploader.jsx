...
//           <div className="h-32 flex relative" key={`${link}-${index}`}>
//             <Image className="rounded-2xl w-full object-cover" src={link} alt={`Photo ${index + 1}`} />
//             <button
...
//           </div>
//         ))}
//         <label className="h-32 cursor-pointer flex items-center gap-1 justify-center border border-dashed rounded-2xl p-2 text-2xl text-gray-600 hover:bg-gray-100 transition">
//           <input type="file" multiple className="hidden" onChange={uploadPhoto} />
//           +
//         </label>
//       </div>
